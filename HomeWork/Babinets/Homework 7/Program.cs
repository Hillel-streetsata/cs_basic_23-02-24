...
class Homework7
{
    ...
    static void Task4(string wordnum1)
    {
        ...
        for (int i = 0; i < wordnum1.Length; i += 2)
        {
    ...
    static void Task10()
    {
        try
        {
            ...
            Console.Write("Введіть назву держави(без пропусків): ");
            country = Console.ReadLine();
            Console.Write("Введіть столицю держави (без пропусків): ");
    ...
    static void Task11()
    {
        ...
        string words1 = "хліб";     //"Word";
        string words2 = "холодець"; //"World";
        string words3 = "хлібопіч"; //"Vocabulary";
        Console.Write("Спільні літери ");
        foreach (char word in words1)
        {
            foreach (char words in words2)
            {
                foreach (char wordss in words3)
                {
                    if (words == word && wordss == word)
                    {
                        Console.Write($" {word}");
                    }
                }
        ...
        Console.WriteLine($" для слів {words1}, {words2},{words3}");
        Task12();
    }
    static void Task12()
    {
